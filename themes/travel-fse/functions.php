...
if( !class_exists( 'Travel_Fse_Theme' ) ){
    class Travel_Fse_Theme{
        ...
        public function __construct(){
            ...
            add_action( 'wp_enqueue_scripts', array( $this, 'travel_fse_styles' ) );
            add_action( 'wp_body_open', array( $this, 'the_preloader' ) );
        ...
        public function travel_fse_styles() {
         ...
         * @since  1.0
         *
         * @package Travel FSE WordPress Theme
         */
