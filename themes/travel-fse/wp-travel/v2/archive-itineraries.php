...
<body <?php body_class(); ?>>
	<?php wp_body_open(); ?>
	<?php
	$block_content_header = '<!-- wp:template-part {"slug":"header","tagName":"header","className":"site-header","theme":"travel-fse"} /-->';
	...
	<?php
	$block_content_footer = '<!-- wp:template-part {"slug":"footer","theme":"travel-fse"} /-->';
